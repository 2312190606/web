...
window.addEventListener('DOMContentLoaded', () => {
    resultHeading.textContent = "搜索菜谱或关键词";
...
async function handleMealClick(e) {
    ...
    try {
        ...
        if (data.meals && data.meals[0]) {
            ...
            // 重新绑定返回按钮事件
            const newBackBtn = mealDetailsContent.querySelector("#back-btn");
            newBackBtn.addEventListener("click", () => mealDetails.classList.add("hidden"));
